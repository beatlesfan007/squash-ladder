...
import type { Player, ListPlayersRequest, ListPlayersResponse } from './players_proto_ts'
...
import { PlayersServiceClient } from './players_grpc_web'
...
export const playersService = {
  listPlayers: async (): Promise<ListPlayersResponse> => {
    return new Promise((resolve, reject) => {
      ...
      client.listPlayers(request, new grpc.Metadata(), (err, response) => {
        if (err) {
